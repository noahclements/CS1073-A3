...
public class CircleDriver {
	public static void main(String [] args) {
		...
		Circle C1 = new Circle(150, 150, 70);	// declaring the new circles
		Circle C2 = new Circle(200, 200, 100);
		Circle C3 = new Circle(250, 250, 50);
		Circle C4 =  new Circle(300, 300, 50);

		// C1 conditional statements
		if(C1.intersects(C2) == true) {	// if c1 intersects with c2,
		if(C1.contains(C2) == true) {	// check to see if c1 contains the c2 circle
			System.out.println("C1 contains C2");	// if so, print out that is contains it
		} else {
			System.out.println("C1 intersects with C2");	// if not, just say c1 intersects with c2
		}
	} else {
		System.out.println("C1 is " + C1.distanceTo(C4) + " away from C2");	// if both are false, print out the shortest distance between circles
	}
		...
		Circle C5 = new Circle(350, 350, 50); // delares a new circle method, C5
		
		
		if(C1.contains(C5) == true) {
			System.out.println("C1 contains C5");
		} else {
		System.out.println("C1 does not contain C5");
		}
		...
		System.out.println("C2 does not contain C5");
		}
		...
		System.out.println("C3 does not contain C5");
		}
		...
		System.out.println("C4 does not contain C5");
		}
	...
	Circle C6 = new Circle(450, 450, 30); // declaring two new circles, C6 and C7
